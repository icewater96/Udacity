...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # JL: inputs mean inputs to activation function
        # JL: otuputs mean outputs from activation function
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # JL: if there are multple outputs, should use np.dot() as following
